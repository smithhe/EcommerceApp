...
{
    public static class EcommerceUserConstants
    {
        public const string _updateUserSuccessMessage = "Saved your changes successfully";
        public const string _updateUserErrorMessage = "Failed to save your changes, Please try again later";
